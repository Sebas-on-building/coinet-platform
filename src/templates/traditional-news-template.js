...
// Template with variables that will be replaced with content
const traditionalNewsTemplate = `# {{headline}}
...
/**
 * Structure for traditional news articles with proper formatting
 */
const formatTraditionalNews = (data) => {
