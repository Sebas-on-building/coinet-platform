  ...
  return (
    <div>
      ...
      <Modal open={open} onClose={() => setOpen(false)} title="Default Modal">
        <div style={{ padding: 24 }}>This is a modal. You can put anything here.</div>
      </Modal>
    </div>
  );
};
...
export const WithLongContent = () => {
  ...
  return (
    <div>
      <Button onClick={() => setOpen(true)}>Open Modal</Button>
      <Modal open={open} onClose={() => setOpen(false)} title="Long Content Modal">
...
export const Centered = () => {
  ...
  return (
    <div style={{ height: 400, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <Modal open={open} onClose={() => setOpen(false)} title="Centered Modal" centered>
        <div style={{ padding: 24 }}>This modal is centered.</div>
      </Modal>
    </div>
  );
}; 