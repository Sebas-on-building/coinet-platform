...
export const Placement = () => (
  <div style={{ display: 'flex', gap: 32, justifyContent: 'center', alignItems: 'center', height: 200 }}>
...
export const WithRichContent = () => (
  <Tooltip content={<div><b>Bold</b> <i>Italic</i> <span style={{ color: '#00ffa3' }}>Color</span></div>}>
