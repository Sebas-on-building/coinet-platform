...
export const Default = () => (
  <Card>
    <h3>Default Card</h3>
    <p>This is a default card. You can put any content here.</p>
  </Card>
);

export const WithHeaderAndActions = () => (
  <Card
    header={<div style={{ fontWeight: 700 }}>Card Header</div>}
    actions={<Button size="sm">Action</Button>}
  >
    <p>This card has a header and an action button.</p>
  </Card>
);
...
export const GlassVariant = () => (
  <Card variant="glass">
    <h3>Glass Card</h3>
    <p>This card uses a glassmorphic background.</p>
  </Card>
);

export const WithImage = () => (
  <Card>
    <img src="https://source.unsplash.com/random/400x200" alt="Random" style={{ width: '100%', borderRadius: 8 }} />
    <div style={{ padding: 12 }}>
      <h3>Card with Image</h3>
      <p>Images and media are supported in cards.</p>
    </div>
  </Card>
);
