...
export interface EventCheckboxProps {
  checked: boolean;
...
export const EventCheckbox: React.FC<EventCheckboxProps> = ({ checked, indeterminate, onChange, ariaLabel = 'Select event', className }) => (
  <motion.button
    type="button"
