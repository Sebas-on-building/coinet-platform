...
export const VALID_INSIGHT_PACK: InsightPackV1 = {
  ...
  catalysts_next: [
    {
      id: 'c1',
      topic: 'Potential listings',
      why_it_matters: 'If the token gains traction, exchange listings could significantly increase accessibility and volume',
      evidence_keys: [],
      horizon: 'weeks',
      confidence: 'low',
    },
...
export const EDGE_CASE_FIXTURES = [
  ...
  },
  {
    ...
    expectedOk: true,  // Should extract JSON via locate_braces
    expectedDegraded: false,
  },
  {
    name: 'Fenced JSON',
    input: FENCED_JSON,
    expectedOk: true,  // Should extract via fenced strategy
    expectedDegraded: false,
  },
  {
    name: 'Extra keys in JSON',
    input: EXTRA_KEYS_JSON,
    expectedOk: false,  // Zod strict mode should reject
    expectedDegraded: false,
  },
  {
  ...
  {
    name: 'Numeric literals in summaries',
    input: NUMERIC_LITERALS_JSON,
    expectedOk: false,  // Should fail policy check in strict mode
    expectedDegraded: false,
  },
  {
  ...
  },
  {
    ...
    expectedOk: true,  // Not strictly forbidden, but worth noting
    expectedDegraded: false,
  },
];
