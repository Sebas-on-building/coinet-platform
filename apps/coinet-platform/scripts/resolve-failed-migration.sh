...
if env -u NODE_ENV npx prisma migrate resolve --applied 20251216180000_add_project_knowledge --schema=./prisma/schema.prisma 2>/dev/null; then
...
env -u NODE_ENV npx prisma migrate deploy --schema=./prisma/schema.prisma
